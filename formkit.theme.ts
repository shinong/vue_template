...
/**
  ...
  *
  * @checksum - 0b06d7e03202b946b03f13119382af8f0a4a5a914cccc41cfd5b67f4e7c71126
  * @variables - radius=rounded,accentColor=blue,colorTemperature=neutral,spacing=1.5,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
