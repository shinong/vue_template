 ...
 *
 * @checksum - c42357797a3beb2fcc363890105e68f4bef4308a5fc491f56107054b34d35620
 * @variables - radius=rounded-lg,accentColor=green,colorTemperature=stone,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
